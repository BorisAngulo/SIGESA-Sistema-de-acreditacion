    ...
    public function run()
    {
        ...
        if ($mecanica) {
            CarreraModalidad::create([
                ...
                'fecha_ini_proceso' => null,
                'fecha_fin_proceso' => null,
                'fecha_ini_aprobacion' => '2019-09-05 08:00:00',
                'fecha_fin_aprobacion' => '2025-09-03 17:00:00',
                'puntaje_acreditacion' => null,
                'created_at' => now(),
                'updated_at' => now(),
            ]);
        ...
        if ($medicina) {
            CarreraModalidad::create([
                ...
                'fecha_ini_proceso' => null,
                'fecha_fin_proceso' => null,
                'fecha_ini_aprobacion' => '2019-05-12 08:00:00',
                'fecha_fin_aprobacion' => '2025-05-12 17:00:00',
                'puntaje_acreditacion' => null,
                'created_at' => now(),
                'updated_at' => now(),
        ...
        if ($agronomica) {
            CarreraModalidad::create([
                ...
                'fecha_ini_proceso' => null,
                'fecha_fin_proceso' => null,
                'fecha_ini_aprobacion' => '2023-12-11 08:00:00',
                'fecha_fin_aprobacion' => '2029-12-11 17:00:00',
                'puntaje_acreditacion' => null,
                'created_at' => now(),
                'updated_at' => now(),
            ]);
        ...
        if ($odontologia) {
            CarreraModalidad::create([
                ...
                'fecha_ini_proceso' => null,
                'fecha_fin_proceso' => null,
                'fecha_ini_aprobacion' => '2023-09-18 08:00:00',
                'fecha_fin_aprobacion' => '2029-09-18 17:00:00',
                'puntaje_acreditacion' => null,
                'created_at' => now(),
                'updated_at' => now(),
        ...
        if ($enfermeria) {
            CarreraModalidad::create([
                ...
                'fecha_ini_proceso' => null,
                'fecha_fin_proceso' => null,
                'fecha_ini_aprobacion' => '2024-10-01 08:00:00',
                'fecha_fin_aprobacion' => '2030-10-01 17:00:00',
                'puntaje_acreditacion' => null,
                'created_at' => now(),
                'updated_at' => now(),
            ]);
